...
- Partial plugin support (LV2, VST3 (experimental and lacks few features, will not work with timer based UIs like geonkick's), and CLAP only).
...
The video uses [VSCO2](https://versilian-studios.com/vsco-community) pack's instruments via [samplo](https://github.com/mlm-games/samplo-clap), and plays the midi file from [here](https://www.ninsheetmusic.org/download/mid/5282) ([ninsheetmusic](https://www.ninsheetmusic.org/))
